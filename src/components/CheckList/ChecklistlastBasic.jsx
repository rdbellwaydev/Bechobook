...
//   const { getBasicLiteBrochureBooks } = useBrochureService();
...
//       try {
//         const result = await getBasicLiteBrochureBooks();
...
//         "https://bb.bechobookscan.com/api/basic-brochure-books",
//         {
//           params: {
//             page: page, // Passing page number as a query parameter
//           },
//         }
//       );
...
//       setBooks(data); // Set books for the current page
//       setFilteredBooks(data || []);
//       setTotalPrice(response.data.total_price); // Set the total price
//       setCurrentPage(pagination.current_page); // Set the current page
...
//   // Load books on component mount or when current page changes
//   // useEffect(() => {
//   //   fetchBooks(currentPage);
//   // }, [currentPage]);
//   useEffect(() => {
//     setLoading(true);
//     fetchBooks(currentPage); // Fetch books when the page changes
//   }, [currentPage]);
...
//             <img src={bookItem.book.image} alt={bookItem.book.title} />
//             <h3>{bookItem.book.title}</h3>
//             <p>{bookItem.book.synopsis}</p>
...
//           <span className="text-gray-700">₹{totalPrice}</span>
//         </div>
//         <button className="mt-4 w-full bg-orange-500 text-white py-2 rounded-md transition duration-300">
//           Contact us
//         </button>
//       </div>
//       <Footer/>
      ...
      {filteredBooks.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 p-8">
          {filteredBooks.map((bookItem) => {
            ...
            const bookSubjects = formatArrayOrString(book?.subjects); // Handle both array and string
            return (
              <div
                key={book.isbn13}
